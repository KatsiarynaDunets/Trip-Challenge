...
class POIVC: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        databaseManager.addPOIs() // Добавление POI в базу данных
        let allPOIs = databaseManager.getAllPOIs() // Получение всех POI
    }
}

//class POIVC: UIViewController {
//    var poi: PointsOfInterest? // Экземпляр модели данных
//
