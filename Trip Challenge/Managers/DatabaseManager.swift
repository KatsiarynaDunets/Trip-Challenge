...
//MARK: POIs
    ...
    func addPOIs() {
        guard let image1 = UIImage(named: "image1")?.jpegData(compressionQuality: 1.0) ,
              ...
              let image15 = UIImage(named: "image15")?.jpegData(compressionQuality: 1.0) else {
...
////    DataManager реализован как singleton, что обеспечивает глобальный доступ и предотвращает множественные экземпляры.
//    
//    
...
//            let container = NSPersistentContainer(name: "YourModelName") // Укажите название вашей модели данных
...
//        }
//    
////MARK: CRUD Operations: Функции addPOI, fetchAllPOIs, и fetchAllChallenges позволяют выполнять операции создания и чтения
//    
//        // Добавление новых POI
//        func addPOI(category: String, description: String, id: Int32, image: Data, lat: Double, lon: Double, number: Int16, promo: Bool, status: String, title: String) {
//            let newPOI = PointOfInterest(context: context)
//            newPOI.poiCategory = category
//            newPOI.poiDescription = description
//            newPOI.poiID = id
//            newPOI.poiImage = image
//            newPOI.poiLat = lat
//            newPOI.poiLon = lon
//            newPOI.poiNumber = number
//            newPOI.poiPromo = promo
//            newPOI.poiStatus = status
//            newPOI.poiTitle = title
//            
//            saveContext()
//        }
//        
//        // Получение всех POI
//        func fetchAllPOIs() -> [PointOfInterest] {
//            let request: NSFetchRequest<PointOfInterest> = PointOfInterest.fetchRequest()
//            do {
